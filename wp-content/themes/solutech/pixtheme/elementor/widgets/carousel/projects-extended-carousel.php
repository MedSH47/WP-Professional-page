...
class Widget_Projects_Extended_Carousel extends Base_Posts_Carousel {

    public function get_name() {
        return 'pixtheme-projects-extended-carousel';
    }

    public function get_title() {
        return esc_html__( 'Projects Carousel with Filter', 'solutech' );
    }
        ...
        if ( 'yes' === $settings['show_filter'] ){
            ...
            if ( ! empty( $term_slugs = $settings['include_term_slugs'] ) ) :
                foreach( $term_slugs as $slug ) {
                    $term = get_term_by( 'slug', $slug, 'pix-portfolio-cat' );
