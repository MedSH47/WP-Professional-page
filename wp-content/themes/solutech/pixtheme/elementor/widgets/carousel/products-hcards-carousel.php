...
class Widget_Products_Hcards_Carousel extends Base_Posts_Carousel {

    public function get_name() {
        return 'pixtheme-products-hcard-carousel';
    }

    public function get_title() {
        return esc_html__( 'Products Horizontal Cards Carousel', 'solutech' );
    }
    ...
    protected function print_slider( array $settings = null ) {
        ...
        <div <?php $this->print_render_attribute_string( 'slider' ); ?>>
            ...
            ?>
            <div class="swiper-container lastchanceProducts">
    ...
    protected function print_slide( array $settings ) {
        ...
        get_template_part( 'template-parts/elementor/woocommerce/content', 'product-hcard' );
    }
