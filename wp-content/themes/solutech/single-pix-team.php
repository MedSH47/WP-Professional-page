...
if ( pixtheme_get_option( 'portfolio_settings_related_show', 'off' ) == 'on' ) :
	$pixtheme_portfolio_related_title = pixtheme_get_option( 'portfolio_settings_related_title', esc_html__('Our Doctors', 'solutech' ) );
...
<div class="service-page-footer">
	<div class="container">
        <span><?php previous_post_link( '%link', '<i class="icon-arrow-left"></i>'.esc_html__('Previous', 'solutech'), false, '', 'portfolio_category'); ?></span>
        ...
        <span class="pix-text-right"><?php next_post_link( '%link', esc_html__('Next', 'solutech').'<i class="icon-arrow-right"></i>', false, '', 'portfolio_category' ); ?></span>
	</div>
</div>
