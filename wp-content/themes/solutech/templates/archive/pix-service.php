...
$image_size = $image_class = pixtheme_get_setting('pix-images-service-cat', 'pixtheme-origin');
if($pix_col == 3){
    $image_size .= '-col-3';
} elseif($pix_col > 3) {
    $image_size .= '-col-4';
...
<!-- ========================== -->
    ...
    <div id="service-archive-section" class="pix-col-<?php echo esc_attr($pix_col); ?>">
    ...
    if ( $wp_query->have_posts() ) : ?>
        ...
        <div class="pix-isotope pix-service">
